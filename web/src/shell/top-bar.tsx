...
export function TopBar({ title, context, chrome }: TopBarProps) {
  return (
    <header className="flex h-(--topbar-h) min-w-0 items-center justify-between gap-4 border-b border-line-soft bg-bg pr-[calc(--spacing(5)+env(safe-area-inset-right))] pl-6">
